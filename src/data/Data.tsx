...
export const cards: CardProps[] = [
  ...
  },
  {
    ...
    durationMin: 60,
    details: [
      { description: 'Meleg olajos masszázs', price: 10000, durationMin: 60 },
      { description: 'Aromaolajos Masszázs', price: 8000, durationMin: 60 },
      { description: 'Testradírozás', price: 7500, durationMin: 30 },
    ],
  },
  {
    title: 'Talpmasszázs',
